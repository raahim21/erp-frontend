...
export const SpinnerIcon: React.FC<IconProps> = (props) => (
    <svg className="animate-spin" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <path d="M12 2a10 10 0 0110 10" stroke="currentColor" strokeWidth="4" strokeLinecap="round" opacity="0.75"></path>
    </svg>
);
